...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [python-function->python-functions-acc...(truncated), main->hello]
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/sample-accelerators/python-functions-accelerator.git->https://github.com/s...(truncated), python-function->python-functions-acc...(truncated), main->main]
...
┃ ┃ ┃ ┗ ┗ ┗ ┗  Info Will replace [python-function->python-functions-acc...(truncated)]
